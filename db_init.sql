...
(6, 'A strapiombo sul Lago di Garda dal Rifugio Altissimo \"<em>Damiano Chiesa</em>\"', 'Un percorso spettacolare con vista a 360<abbr title="gradi">°</abbr> sul Lago di Garda e le montagne trentine', 'Questo <strong>percorso</strong> è abbastanza impegnativo per il dislivello medio ma il sentiero è semplice e affrontabile da tutti con un minimo di allenamento. Durante tutta la camminata si potrà ammirare da varie prospettive il <strong>Lago di Garda</strong>, i monti della Lessinia e una parte delle Dolomiti.', 'Si parte dal <strong>Rifugio Graziani a Brentonico</strong> (<abbr title="Trentino">TN</abbr>) e si prosegue per la strada sterrata in direzione nord-ovest seguendo le indicazioni per il <strong>Rifugio Altissimo \"<em>Damiano Chiesa</em>\"</strong>. Una volta arrivati è possibile proseguire per qualche metro per raggiungere altri punti panoramici. Il ritorno è previsto per la stessa strada.', '6_RifugioMonteAltissimo.gpx', 460, 460, 5.3, 'Rifugio \"Damiano Chiesa\" del Monte Altissimo', 'Percorso impegnativo dal Rifugio Graziani al Rifugio \"Damiano Chiesa\" con vista sul Lago di Garda', 'Rifugio Altissimo,Rifugio Damiano Chiesa,Monte Altissimo,Lago di Garda'),
